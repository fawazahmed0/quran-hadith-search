...
D'après Abou Hourayra (que Dieu l'agrée) ayant vu un homme qui ne s'était pas lavé les talents en faisant les ablutions, le Prophète (paix et bénédiction de Dieu sur lui) lui dit : "Malheur aux talons quand ils seront exposés au feu de l'Enfer!" Recommandation d'accomplir parfaitement ses ablutions
</div>
<div style={{backgroundColor:'#f8f9fa',padding:20, marginBottom: 10}}><table> <thead> <tr> <th>References:</th> <th></th> </tr> </thead> <tbody><tr><td>Hadith No</td><td>573</td></tr><tr><td>Arabic No</td><td>242.01</td></tr><tr><td>Reference</td><td>Book 2 Hadith 40</td></tr></tbody></table></div>
