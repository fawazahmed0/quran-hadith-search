...
‘Абдуллах, да будет доволен им Аллах, сказал: «Готов обменяться проклятиями с любым желающим: короткая сура “ан-Ниса‘” была ниспослана после предписания соблюдать ‘идду четыре месяца и десять дней»
